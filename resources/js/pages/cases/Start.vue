...
const selectedCaseSoortId = ref<number | null>(null);
const filteredCases = computed(() =>
    props.cases.filter(
        (item) =>
            selectedCaseSoortId.value === null ||
            item.case_soort_id === selectedCaseSoortId.value,
    ),
);
        ...
        <div class="grid gap-6" :class="{ 'lg:grid-cols-2': !isConsultMode }">
            ...
            >
                ...
                >
                    ...
                    >
                        Bestaande case (Team: {{ teamNaam ?? 'Onbekend' }})
                    </h2>
                    <label
                ...
                <div v-if="filteredCases.length" class="mt-6 space-y-3">
                    ...
                    >
                        <div class="flex flex-col">
                            ...
                            >
                                {{ item.case_soort_naam }} ({{
                                    item.case_soort_code
                                }})
                            </span>
                            <span
