    ...
    <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
        ...
        <div class="rounded-2xl border border-sidebar-border/70 bg-gradient-to-br from-white via-white to-amber-50 px-6 py-5 shadow-sm dark:border-sidebar-border dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
            <h1 class="text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">
                {{ isConsultMode ? 'Kies een Case om te Raadplegen' : 'Kies of maak een case' }}
            </h1>
        ...
        <div class="grid gap-6" :class="{ 'lg:grid-cols-2': !isConsultMode }">
            <div class="rounded-2xl border border-sidebar-border/70 bg-white p-6 shadow-sm dark:border-sidebar-border dark:bg-gray-900">
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">
                    {{ isConsultMode ? 'Kies een case om te raadplegen.' : 'Ga verder waar je gebleven was.' }}
                </p>
                ...
                <div v-if="cases.length" class="mt-6 space-y-3">
                    ...
                    >
                        ...
                        <Link
                            ...
                            :href="isConsultMode
                                ? consult({ query: { case: item.id } })
                                : edit({ query: { case: item.id } })"
                        >
                            Open
                        </Link>
                    </div>
            ...
            <div v-if="!isConsultMode" class="rounded-2xl border border-sidebar-border/70 bg-white p-6 shadow-sm dark:border-sidebar-border dark:bg-gray-900">
